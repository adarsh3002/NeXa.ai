...
function sendSMS(Email, otp) {
    ...
    let mailOptions = {
        ...
        html: `Please keep your OTP confidential and do not share it with anyone. The OTP will be valid for five minutes only. <br><strong>OTP: ${otp}</strong><br><br>Thank you for choosing NEXA!<br><br>If you have any questions, please contact us at:<br>Adarsh Kumar : ak47kumaradarsh@gmail.com<br>Best regards,<br>The NEXA Team`,
    };
